...
public class ShareWithContact extends XmppActivity implements XmppConnectionService.OnConversationUpdate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ListItemAdapter(this, contacts);
                ...
                public void onPresenceSelected() {
                    ...
                    if (share.image) {
                        ...
                        for (Iterator<Uri> i = share.uris.iterator(); i.hasNext(); i.remove()) {
                            ShareWithContact.this.xmppConnectionService
